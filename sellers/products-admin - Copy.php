...
//alert(val);
   $.ajax({
     ...
     success: function (response) {
         ...
         var supDiv = document.getElementById("supplier_div");

         checkbox = document.createElement("input");
         checkbox.setAttribute("id", "idString");
         checkbox.setAttribute("name", "idString");
         checkbox.setAttribute("type", "checkbox");
         checkbox.setAttribute("value", "0");
         supDiv.appendChild(checkbox);
         var label = document.createElement('label')
         label.htmlFor = idString;
         label.appendChild(document.createTextNode("Manufacturer"));
          //label.setAttribute("value", "Manufacturer");
        //  label.appendChild(document.createTextNode('text for label after checkbox'));
         //label.appendChild(document.createTextNode(pair));
      //   var element = document.getElementById("content");
      supDiv.appendChild(label);
              supDiv.appendChild(document.createElement("br"));
        // supDiv.appendChild(label);
      //    supDiv.appendChild(document.createElement("br"));
          //document.getElementByNamesupplier_div
        // document.getElementByName("suppliers[]").style.visibility = "visible";
         //document.getElementByName("suppliers[]").value = "Manufacturer";
        // document.getElementById("supcheck").value = "Wholesaler";

        // document.getElementById("supcheck"). = "Retailer";
         //document.getElementById("supcheck").value = "Wholesaler2";

      //   if (sup_array.length >5)
    //     document.getElementById("testing_div").style.visibility = "visible";
      //   document.getElementById("test_text").value = "Text String Message";
      //   for (var i=0;i<sup_array.length;i++)
      //   {
        //   var supValue = sup_array[i];
        //   if(jQuery.trim(supValue) != "" )
          // {
          //   document.getElementById("supcheck").value = supValue;
//document.getElementById("supcheck").innerHTML =supValue;
  //         }
...
if ($result->num_rows > 0) {
                ...
                while($row_user = $result_user->fetch_assoc()) {
                  ...
                  <div class="form-group" >
                  <label for="focusedinput" class="col-sm-2 control-label">Testing Type</label>
                  <div class="col-sm-8" id ="testing_div" style="visibility:hidden" >
                    <input type="text" class="form-control1" id="test_text" value="" name="test_text" >
                  </div>
                  </div>
								<div class="form-group">
