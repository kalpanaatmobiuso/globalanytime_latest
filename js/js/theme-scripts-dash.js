(function($) {
	...
	***************************************************************************************************************/
	...
	/* MEMBERSHIP PACKAGES STARTED */
		$('.pf-membership-splan-button a').live('click', function() {
		...
		$('.pfsubmit-title-membershippack').live('click', function() {
			$('.pfsubmit-inner-membership').show("fade");
			$('.pfsubmit-inner-membership-payment').hide("fade");
		});

		$('.pfsubmit-title-membershippack-payment').live('click', function() {
			$('.pfsubmit-inner-membership').hide("fade");
			$('.pfsubmit-inner-membership-payment').show("fade");
		});

		// AJAX MEMBERSHIP PAYMENT PROCESS
		$("#pf-ajax-purchasepack-button").live("click touchstart",function(){
	...
	/* PROFILE UPDATE FUNCTION STARTED */
		$('#pf-ajax-profileupdate-button').live('click touchstart',function(){
		...
		$.pf_get_modules_now = function(itemid){
			...
			$.ajax({
				...
				if (obj.features == null || obj.features == '' || obj.features == 'undefined') {
					...
					$('.pfitemdetailcheckall').live('click',function(event) {
						$.each($('[name="pffeature[]"]'), function(index, val) {
							 $(this).attr('checked', true);
						});
					});

					$('.pfitemdetailuncheckall').live('click',function(event) {
						$.each($('[name="pffeature[]"]'), function(index, val) {
	...
	/* ITEM ADD/UPDATE FUNCTION STARTED  */
		$("#pf-ajax-uploaditem-button").live("click touchstart",function(){
		...
		/*Delete Item*/
		$(".pf-itemdelete-link").live("click touchstart",function(){
	...
	/* ON-OFF SYSTEM STARTED */
		$(".pfstatusbuttonaction").live('click touchstart','',function(event) {
